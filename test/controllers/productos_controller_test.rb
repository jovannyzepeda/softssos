...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { clave: @producto.clave, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio, producto_padre_id: @producto.producto_padre_id }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { clave: @producto.clave, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio, producto_padre_id: @producto.producto_padre_id }
    assert_redirected_to producto_path(assigns(:producto))
  end
