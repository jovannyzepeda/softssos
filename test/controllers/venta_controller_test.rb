...
class VentaControllerTest < ActionController::TestCase
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post :create, ventum: { clave: @ventum.clave, cliente: @ventum.cliente, fecha: @ventum.fecha, iva: @ventum.iva }
    end
  ...
  test "should update ventum" do
    patch :update, id: @ventum, ventum: { clave: @ventum.clave, cliente: @ventum.cliente, fecha: @ventum.fecha, iva: @ventum.iva }
    assert_redirected_to ventum_path(assigns(:ventum))
  end
